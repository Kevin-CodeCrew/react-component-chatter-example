...
/*
    A stateful component that can send messages to other components.

 */
class LittleChildComponent extends Component
{
    constructor(props)
    {
        super(props);
    ...
    {
        return (
            <div className={'little-component'}>
...
export default LittleChildComponent;
